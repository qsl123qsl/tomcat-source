 ...
 * 主要是定义了如下
 * 
 * Service与容器Container的关系，一对一关系， getter/setter方法
 * Service的属性name getter/setter方法
 * Service与服务器Server的关闭  getter/setter方法
 * Service下面管理Connector,可以多个，所以有Connector的增删查方法
 * Service下面管理Excutor，可以多个，所以有Excutor的增删查方法
 * @author Shilin.Qu
 *
 */
