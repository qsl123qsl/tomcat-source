...
/**
 * Server下面管理多个Service，所以有增删查方法 addService，findServices，removeService
 * @author Shilin.Qu
 *
 */
public interface Server extends Lifecycle {
    ...
    // ----------------------------------------- getPort() setPort()  getAddress  setAddress 用于给Server绑定ip和port
    /**
    ...
    // ----------------------------------------- getShutdown,setShutdown,await这三个方法是一个系列，用来等待一个shutdown一个信号来关闭server
